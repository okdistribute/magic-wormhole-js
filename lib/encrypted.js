...
async function initialize({ send, subscribe }, side, password) {
  ...
  // TODO: HACK!!!
  // this spake2 should be an external library packaged already for
  // requiring in the browser. fix it!
  ...
  let key = window.spake2.finish(spake2State, inbound);
  // console.log('key', key);
  ...
  return { key: key, send: mySend, subscribe: mySubscribe };
  // TODO verifier
}
